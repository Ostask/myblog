  ...
  <div class="publish">
    <el-scrollbar class="page-content-scroll">
      <div class="article-place">
        ...
        <div class="tag-place">
          <label class="el-form-item__label" style="width: 80px;line-height:30px;">页面标签</label>
          <el-tag
            :key="tag"
        ...
        <el-row style="text-align: center">
          <el-button type="success" plain>发布页面</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      back() {
        this.$router.push({ path: '/manage/practiceMng' });
      }
    },
    computed: {
